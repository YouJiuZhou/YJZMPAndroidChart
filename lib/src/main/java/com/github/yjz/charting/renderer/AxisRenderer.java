...
public abstract class AxisRenderer extends Renderer {
    ...
    public static final float SCALE_LINE_MAX_LEN = Utils.convertDpToPixel(10f); //长刻度线默认长度
    public static final float SCALE_LINE_MIN_LEN = Utils.convertDpToPixel(7f); //短刻度线默认长度
     ...
     * 刻度线画笔
     */
    protected Paint mAxisScaleLinePaint;
    ...
    public AxisRenderer(ViewPortHandler viewPortHandler, Transformer trans, AxisBase axis) {
        ...
        if(mViewPortHandler != null) {
            ...
            mAxisScaleLinePaint = new Paint();
            mAxisScaleLinePaint.setColor(Color.BLACK);
            mAxisScaleLinePaint.setStrokeWidth(1f);
            mAxisScaleLinePaint.setStyle(Style.STROKE);
