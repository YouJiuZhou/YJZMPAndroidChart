...
import com.github.yjz.charting.utils.FSize;
...
public class XAxisRenderer extends AxisRenderer {
    ...
    public void renderAxisLabels(Canvas c) {
        ...
        if (mXAxis.getPosition() == XAxis.XAxisPosition.TOP) {
            ...
            if (mXAxis.isDrawScale()){
                drawLabels(c, mViewPortHandler.contentTop() - yoffset - SCALE_LINE_MAX_LEN, pointF);
            }else{
            ...
            if (mXAxis.isDrawScale()){
                drawLabels(c, mViewPortHandler.contentTop() + yoffset + mXAxis.mLabelRotatedHeight + SCALE_LINE_MAX_LEN, pointF);
            }else{
            ...
            if (mXAxis.isDrawScale()){
                drawLabels(c, mViewPortHandler.contentBottom() + yoffset + SCALE_LINE_MAX_LEN, pointF);
            }else{
            ...
            if (mXAxis.isDrawScale()){
                drawLabels(c, mViewPortHandler.contentBottom() - yoffset - mXAxis.mLabelRotatedHeight  - SCALE_LINE_MAX_LEN, pointF);
            }else{
    ...
    public void renderScaleLines(Canvas c) {
        ...
        mAxisScaleLinePaint.setColor(mXAxis.getAxisLineColor());
    ...
    protected void drawScale(Canvas canvas, float startX, float offset) {
        ...
        canvas.save();
        if (mXAxis.getPosition() == XAxis.XAxisPosition.BOTTOM) { //X轴位置在下方时
            for (int i = 0; i <= 5; i++) {
                canvas.save();
                canvas.translate(offset * i, 0);
                if (i % 5 == 0) {
                    canvas.drawLine(startX, bottomY + SCALE_LINE_MAX_LEN, startX, bottomY, mAxisScaleLinePaint);//画长刻度线
                } else {
                    canvas.drawLine(startX, bottomY + SCALE_LINE_MIN_LEN, startX, bottomY, mAxisScaleLinePaint);//画短刻度线
                }
                canvas.restore();
            }
        } else if (mXAxis.getPosition() == XAxis.XAxisPosition.BOTTOM_INSIDE){
        ...
        }else if (mXAxis.getPosition() == XAxis.XAxisPosition.TOP) { //X轴位置在上方时
            for (int i = 0; i <= 5; i++) {
                canvas.save();
                canvas.translate(offset * i, 0);
                if (i % 5 == 0) {
                    canvas.drawLine(startX, topY - SCALE_LINE_MAX_LEN, startX, topY, mAxisScaleLinePaint);//画长刻度线
                } else {
                    canvas.drawLine(startX, topY - SCALE_LINE_MIN_LEN, startX, topY, mAxisScaleLinePaint);//画短刻度线
                }
                canvas.restore();
            }
        } else if (mXAxis.getPosition() == XAxis.XAxisPosition.TOP_INSIDE){
        ...
        }else if (mXAxis.getPosition() == XAxis.XAxisPosition.BOTH_SIDED) { //上下都有X轴时
            for (int i = 0; i <= 5; i++) {
                canvas.save();
                canvas.translate(offset * i, 0);
                if (i % 5 == 0) {
                    //画长刻度线
                    canvas.drawLine(startX, topY + SCALE_LINE_MAX_LEN, startX, topY, mAxisScaleLinePaint);//顶部X轴的刻度
                    canvas.drawLine(startX, bottomY + SCALE_LINE_MAX_LEN, startX, bottomY, mAxisScaleLinePaint);//底部X轴的刻度
                } else {
                    //画短刻度线
                    canvas.drawLine(startX, topY + SCALE_LINE_MIN_LEN, startX, topY, mAxisScaleLinePaint);//顶部X轴的刻度
                    canvas.drawLine(startX, bottomY + SCALE_LINE_MIN_LEN, startX, bottomY, mAxisScaleLinePaint);//底部X轴的刻度
                }
                canvas.restore();
            }
        }
